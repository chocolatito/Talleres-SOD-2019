...
public class ServerCerntral extends UnicastRemoteObject implements IServerCerntral {
    ...
    public ServerCerntral() throws RemoteException {
        super();
        testigo = true;
    ...
    public void Conceder() {
        if (solicitudes.size() > 0 && testigo) {
            ...
            try {
                ...
                Logger.getLogger(ServerCerntral.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
...
//__________________________________
    public static void main(String[] args) {
        ...
        try {
            objSCentral = new ServerCerntral();
